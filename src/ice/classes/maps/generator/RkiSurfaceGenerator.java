...
public class RkiSurfaceGenerator extends PlanetGenerator{
    public float heightScl = 0.9f, octaves = 8, persistence = 0.7f, heightPow = 3f, heightMult = 1.6f;

    Block[] terrain = {Blocks.ice, Blocks.ice, Blocks.redIce, Blocks.redIce, Blocks.ice, Blocks.snow, Blocks.snow, Blocks.redIce, Blocks.snow, Blocks.ice, Blocks.snow};
