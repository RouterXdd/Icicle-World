        ...
        return table -> {
            ...
            for(T t : orderedKeys){
                ...
                table.table(Styles.grayPanel, bt -> {
                    ...
                    if (type instanceof ScaledBasicBulletType){
                        if(((ScaledBasicBulletType) type).healthScale != 0) {
                            int val = (int) (((ScaledBasicBulletType) type).healthScale);
                            sep(bt, Core.bundle.format("bullet.healthscale", ammoStat(val)));
                        }
                    }
